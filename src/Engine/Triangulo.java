...
public class Triangulo extends Poligono {
     ...
     *
     * @param pontos Um array de objetos da classe Engine.Ponto representando os vértices do triângulo.
     *               O array deve conter exatamente três pontos e os pontos não podem ser colineares.
     *               Caso contrário, lança uma IllegalArgumentException com a mensagem "Engine.Triangulo:iv".
    ...
    public Triangulo(Ponto[] pontos) {
        ...
        if (pontos.length != 3) {
            throw new IllegalArgumentException("Engine.Triangulo:iv");
        }
