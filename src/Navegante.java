...
public class Navegante {
     ...
     *
     * @param rota a rota contendo os segmentos para inicializar esta instância de Navegante
     ...
     *
     * @param windSpeed   Um objeto {@code Vetor} representando a velocidade do vento.
     ...
     * @return Uma lista de objetos {@code Vetor} representando a velocidade em cada
